        ...
        <div class="forgot-card">
            ...
            <div class="mb-3">
                ...
                <div class="input-group-custom">
                    ...
                    <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control-custom" TextMode="Email" placeholder="you@example.com"></asp:TextBox>
                </div>
                <asp:RequiredFieldValidator ID="rfvEmail" runat="server" 
                    ControlToValidate="txtEmail" 
                    ErrorMessage="Email is required" 
                    Display="Dynamic" 
                    CssClass="error-text text-danger" 
                    ValidationGroup="ForgotGroup">
                </asp:RequiredFieldValidator>
            </div>

            <div class="mt-4">
                <asp:LinkButton ID="btnSendOtp" runat="server" OnClick="btnSendOtp_Click" CssClass="btn-reset" ValidationGroup="ForgotGroup">
                    Send OTP <i class="fa-solid fa-paper-plane" style="font-size: 12px;"></i>
                </asp:LinkButton>
            </div>
            ...
            <div class="footer-link">
                <a href="Login.aspx"><i class="fa-solid fa-arrow-left me-1"></i> Back to Login</a>
            </div>
