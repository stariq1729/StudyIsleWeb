...
<div id="settingsModal" class="modal-overlay">
    <div class="modal-content-box">
        <button type="button" class="btn-close position-absolute" style="top:30px; right:30px;" onclick="closeModal()"></button>
    ...
    <asp:HiddenField ID="hfAvatar" runat="server" ClientIDMode="Static" />
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 text-primary fw-bold small">ACADEMIC PROFILE</div>
            
            <div class="col-md-6">
                <label class="small text-muted"><i class="fas fa-user me-2"></i>FULL NAME</label>
                <asp:TextBox ID="txtName" runat="server" CssClass="form-control" placeholder="Tariq" />
            </div>
            <div class="col-md-6">
                <label class="small text-muted"><i class="fas fa-graduation-cap me-2"></i>CLASS / GRADE</label>
                <asp:DropDownList ID="ddlClass" runat="server" CssClass="form-select"></asp:DropDownList>
            </div>

            <div class="col-md-6">
                <label class="small text-muted"><i class="fas fa-calendar me-2"></i>DATE OF BIRTH</label>
                <asp:TextBox ID="txtDOB" runat="server" CssClass="form-control" TextMode="Date" />
            </div>
            <div class="col-md-6">
                <label class="small text-muted"><i class="fas fa-school me-2"></i>SCHOOL BOARD</label>
