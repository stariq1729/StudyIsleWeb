<%@ Page Title="Subject Details" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="SubjectDetails.aspx.cs"
    Inherits="StudyIsleWeb.SubjectDetails" %>

<%-- This page comes after selection of class and subject and shows chapter-wise or year-wise material --%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container py-5">
        <header class="mb-5">
            ...
            <p class="text-muted">
                Select the category of material you wish to access.
            </p>
        </header>
                ...
                <asp:Repeater ID="rptYears" runat="server">
                    <ItemTemplate>
                        <div class="col-md-3 col-6">
                            <a href='<%# "SetSelection.aspx?sid=" + Request.QueryString["sid"] +
