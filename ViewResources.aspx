<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewResources.aspx.cs" Inherits="StudyIsleWeb.ViewResources" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        ...
        /* Dynamic Colors based on ContentType */
                        ...
                        <div class="resource-card">
                            ...
                            <div>
                                <a href='<%# Eval("FilePath") %>' target="_blank" class="btn btn-primary rounded-pill px-4">
                                    <i class="fas fa-download me-2"></i>Open
                                </a>
                            </div>
                        </div>
                    </ItemTemplate>
