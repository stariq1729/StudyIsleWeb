...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-card shadow-sm">
        ...
        <hr />
        <h5 class="text-primary">Hero Section Content (SEO)</h5>

        <div class="mb-3">
            <label class="form-label font-weight-bold">Hero Title</label>
            <asp:TextBox ID="txtHeroTitle" runat="server" CssClass="form-control" placeholder="e.g. Free CBSE Resources"></asp:TextBox>
        </div>

        <div class="mb-3">
            <label class="form-label font-weight-bold">Hero Subtitle</label>
            <asp:TextBox ID="txtHeroSubtitle" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="3" placeholder="Enter a brief description for the hero section..."></asp:TextBox>
        </div>
        <hr />
        ...
        <asp:Button ID="btnSave" runat="server" Text="Save Board" CssClass="btn btn-primary" OnClick="btnSave_Click" />
        <a href="ManageBoards.aspx" class="btn btn-secondary ms-2">Cancel</a>
    </div>
